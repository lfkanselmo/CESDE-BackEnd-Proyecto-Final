...
public record PropertyListRecord(Integer id , Double price, Boolean free, String offer, String properyType, Integer rooms,
                                 Integer bathrooms, Boolean courtyard, Integer level, Double area, Boolean naturalGas,
                                 Boolean laundryArea, String address, String district, String city,
                                 OwnerListRecord owner) {
